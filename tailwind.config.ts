  ...
  theme: {
    extend: {
      animation: {
        ...
        "fade-out-left": "fade-out-left 1s ease-in-out",
        ...
        "placeholder-wave": "placeholder-wave 1.5s infinite",
        "show-up-clock": "show-up-clock 1s ease-in-out",
        progress: "progress 1s linear infinite",
        "drop-in": "drop-in 1s ease-in-out",
        "drop-out": "drop-out 1s ease-in-out",
        "fly-in": "fly-in 1s ease-in-out",
        "fly-in-up": "fly-in-up 1s ease-in-out",
        "fly-in-down": "fly-in-down 1s ease-in-out",
        "fly-in-left": "fly-in-left 1s ease-in-out",
        "fly-in-right": "fly-in-right 1s ease-in-out",
        "fly-out": "fly-out 1s ease-in-out",
        "fly-out-up": "fly-out-up 1s ease-in-out",
        "fly-out-down": "fly-out-down 1s ease-in-out",
        "fly-out-left": "fly-out-left 1s ease-in-out",
        "fly-out-right": "fly-out-right 1s ease-in-out",
        "browse-in": "browse-in 1s ease-in-out",
        "browse-out": "browse-out 1s ease-in-out",
        "browse-out-left": "browse-out-left 1s ease-in-out",
        "browse-out-right": "browse-out-right 1s ease-in-out",
